...
<div id="venue" class="section lb">
    <div class="container">
        <div class="section-title text-center" style="background: url('<?php echo e(asset('assetsFrontend/uploads/hero-bg.png')); ?>')">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="message-box">
                    ...
                    <br />
                    <?php endif; ?>
                    <form action="<?php echo e(route('home.event')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php if($errors->any()): ?>
                        <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <select class="form-control" name="id_venue">
                                    ...
                                    <?php $__currentLoopData = $selVenue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($row->id_venue); ?>"><?php echo e($row->get_venue->nama_tempat); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="right-box-pro wow fadeIn">
                    <img src="<?php echo e(asset('assetsFrontend/uploads/gallery_img-05.jpg')); ?>" alt="" class="img-fluid img-rounded">
                </div>
                <!-- end media -->
            </div>
            <!-- end col -->
...
<?php /* C:\xampp\htdocs\CoWorkingSpace\resources\views/users/homepage.blade.php */ ?>