<?php $__env->startSection('content'); ?><div class="col-xl-12 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form method="post" action="<?php echo e(route('transaksi.update',$transaksi->id_transaksi)); ?>"> 
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                            ...
                            <select class="form-control" name="status_booking">
                                <option value="<?php echo e($transaksi->status_booking); ?>"><?php echo e($transaksi->status_booking); ?></option>
...
<?php /* C:\xampp\htdocs\CoWorkingSpace\resources\views/admin/transaksi/editTransaksi.blade.php */ ?>