...
<html lang="en">
    ...
    <link href="<?php echo e(asset('assets/sweetalert-master/src/sweetalert.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
...
<body id="page-top" class="politics_version">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
          <?php echo $__env->make('layouts.front.regNavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </nav>
	
	
    <div class="copyrights">
          <?php echo $__env->make('layouts.front.foot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('assetsFrontend/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assetsFrontend/js/bootstrap-filestyle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/dist/summernote.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/sweetalert-master/src/sweetalert.js')); ?>"></script>
<script>
...
<?php /* C:\xampp\htdocs\CoWorkingSpace\resources\views/layouts/front/masterReg.blade.php */ ?>