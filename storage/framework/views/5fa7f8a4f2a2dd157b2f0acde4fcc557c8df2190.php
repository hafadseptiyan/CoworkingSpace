              ...
              <form method="post" action="<?php echo e(route('venue.update',$venue->id_venue)); ?>" enctype="multipart/form-data"> 
                ...
                <div class="pl-lg-4">
                  <div class="form-group">
                    ...
                    <textarea rows="4" name="deskripsi" class="form-control form-control-alternative"><?php echo e($venue->deskripsi); ?></textarea>
                    <br>
...
<?php /* C:\xampp\htdocs\CoWorkingSpace\resources\views/venue/editVenue.blade.php */ ?>