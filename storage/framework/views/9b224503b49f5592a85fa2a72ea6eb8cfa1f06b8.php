...
<section id="home" class="main-banner parallaxie" style="background: url('<?php echo e(asset('assetsFrontend/uploads/main.jpg')); ?>')">
    ...
    <div id="advantages" class="section lb bg" style="background: url('<?php echo e(asset('assetsFrontend/uploads/hero-bg.jpg')); ?>')">
        <div class="container">
	...
	<div id="event" class="section lb" style="background: url('<?php echo e(asset('assetsFrontend/uploads/hero-bg.png')); ?>')">
		<div class="container">
			<div class="section-title text-center">
			...
			<div class="gallery-list row">
				<?php $__currentLoopData = $web; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-md-4 col-sm-6 gallery-grid gal_a">
					<div class="gallery-single fix">
						<img src="images/<?php echo e($row->image_event); ?>" class="img-fluid" alt="Image">
						<div class="img-overlay">
							<center><br><br><br><br>
							<a href="images/<?php echo e($row->image_event); ?>" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="fa fa-search-plus"> Zoom In</i></a>
							<a href="images/<?php echo e($row->image_event); ?>" data-rel="prettyPhoto[gal]" class="hoverbutton button-group global-radius"><i class="fa fa-pencil"> Detail Event</i></a>
							</center>
						</div>
					</div>
				</div>
				...
				<?php $__currentLoopData = $design; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__currentLoopData = $startup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<div id="venue" class="section lb" style="background: url('<?php echo e(asset('assetsFrontend/uploads/bg3.png')); ?>')">
    <div class="container">
        <div class="section-title text-center">
            ...
            <div class="col-md-4 col-sm-6 col-lg-4">
                <div class="post-box">
                    ...
                    <div class="post-info">
                        ...
                        <p style="font-size:12px"><?php echo $row->deskripsi; ?></p>
                        <hr>
    ...
    <div id="contact" class="section db" style="background: url('<?php echo e(asset('assetsFrontend/uploads/bg3.png')); ?>')">
        <div class="container">
            <div class="section-title text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
	                    <div class="our-team">
                            <div class="pic">
                                <img src="<?php echo e(asset('assetsFrontend/images/logo.png')); ?>">
                            </div>
...
<?php /* C:\xampp\htdocs\CoWorkingSpace\resources\views/users/beranda.blade.php */ ?>